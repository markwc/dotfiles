...
;; RCS:		$Id: vhdl-mode.el,v 33.9 2005/05/17 10:07:08 reto Exp reto $
;; Keywords:	languages vhdl
;; WWW:		http://opensource.ethz.ch/emacs/vhdl-mode.html

(defconst vhdl-version "3.33.4"
  "VHDL Mode version number.")

(defconst vhdl-time-stamp "2005-05-17"
...
(defun vhdl-create-mode-menu ()
  ...
  `("VHDL"
	...
	(if (fboundp 'global-font-lock-mode)
	    'font-lock-auto-fontify 'global-font-lock-mode)) t]
      ["Highlight Keywords"
